...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h1 class="text-xl font-bold text-gray-100">Scene Engine</h1>
    </div>
    ...
    <div v-if="status.status === 'idle'" class="bg-gray-900 rounded-lg border border-gray-800 p-6 space-y-4">
      <h2 class="text-sm font-semibold text-gray-200">Scene Configuration</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-xs text-gray-500 mb-1">Plot Outline</label>
          <select
          ...
          >
            <option :value="null" disabled>Select an outline</option>
            <option
        ...
        <div>
          <label class="block text-xs text-gray-500 mb-1">Scene</label>
          <select
        ...
        <div>
          <label class="block text-xs text-gray-500 mb-1">Characters ({{ characters.length }})</label>
