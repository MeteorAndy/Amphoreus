...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h1 class="text-xl font-bold text-gray-100">Narrative Writer</h1>
    </div>
    ...
    <div class="bg-gray-900 rounded-lg border border-gray-800 p-4">
      <div class="flex items-end gap-4">
        <div class="flex-1">
          ...
          >
            <option value="" disabled>Select an outline</option>
            <option
    ...
    <div v-if="titleCandidates.length > 0" class="bg-gray-900 rounded-lg border border-gray-800 p-4">
      <h3 class="text-sm font-semibold text-gray-200 mb-3">Title Candidates</h3>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
        ...
        >
          ...
          <div class="flex items-center gap-2 mt-1">
            <span class="text-xs text-indigo-400">Score: {{ candidate.score }}</span>
          </div>
