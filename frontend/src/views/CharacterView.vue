...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h1 class="text-xl font-bold text-gray-100">Characters</h1>
      <button
        @click="openCreate"
    ...
    <div>
      <h2 class="text-lg font-semibold text-gray-200 mb-3">Relationships</h2>
      <RelationshipGraph
      ...
      >
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 w-full max-w-lg mx-4 max-h-[80vh] overflow-y-auto">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label class="block text-xs text-gray-500 mb-1">Traits</label>
            ...
            <div>
              <label class="block text-xs text-gray-500 mb-1">Goals</label>
              <div class="flex flex-wrap gap-1 mb-2">
                <span
              ...
              <div class="flex gap-2">
                ...
                />
                <button @click="addGoal" class="px-3 py-1.5 bg-gray-700 text-gray-300 rounded-lg text-xs hover:bg-gray-600 transition-colors">Add</button>
              </div>
            </div>
          </div>
